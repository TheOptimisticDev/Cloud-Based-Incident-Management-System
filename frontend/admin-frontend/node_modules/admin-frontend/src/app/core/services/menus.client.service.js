    ...
    function() {
        ...
        this.addMenuItem = function(menuId, options) {
            ...
            this.menus[menuId].items.push({
                title: options.title || '',
                state: options.state ? (options.state + ((options.params) ? '(' + JSON.stringify(options.params) + ')' : '')) : null,
            ...
            for (var itemIndex in this.menus[menuId].items) {
                if (this.menus[menuId].items[itemIndex].state === parentItemState) {
                    ...
                    this.menus[menuId].items[itemIndex].items.push({
                        title: options.title || '',
                        state: options.state ? (options.state + ((options.params) ? '(' + JSON.stringify(options.params) + ')' : '')) : false,
                        url: options.url,
                        activeState: options.activeState || options.state || '',
                        active: options.active || angular.noop,
                        params: options.params || {},
