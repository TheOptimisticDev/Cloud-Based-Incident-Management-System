...
.page-header {
  ...
  .search{
    ...
    .credentials-for-integration-log{
        display: flex;
    }
    .grow-column {
      flex-grow: 2;
    }
    .credentials-for-integration-log > div {
      margin-right: 20px;
    }
}
ul, ol {
...
.list-group-container > div {
  margin-bottom: 15px;
}
.list-group-container > div > span {
  margin-right: 20px;
}
.list-group-container .collapsed {
  display: none;
}
.list-group-container .expanded {
  display: inline-block;
}
.list-group-container .change {
  padding: 5px 15px;
}
.list-group-container .change .diff {
  padding: 3px 0px;
}
//#######  END re-styling of log
...
.form-group .intl-tel-input:after{
  display: table;
  content: "";
  line-height: 0;
}
