...
angular.module('listings').controller('ListingReceptionistsController', [
	'$scope',
	'$state',
	'$stateParams',
	'$location',
	...
	function($scope, $state, $stateParams, $location, notify, Menus, Authentication, Listing, Accounts, dataFallback) {
            ...
            dataFallback($scope, 'listing', function(id, listing) {
                if(listing) {
                    ...
                    $scope.listing = Listing.get({
                        listingId: id,
                        fields: '_id accountId receptionistsService'
                    }, callback);
                }
            });
        }
        ...
        function getAccount() {
            if (!$scope.account || !$scope.account.receptionistsService){
                $scope.account = Accounts.get({accountId: $scope.listing.accountId, fields: '_id receptionistsService'});
            }
        }
